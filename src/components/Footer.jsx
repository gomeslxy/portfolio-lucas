  ...
  return (
    <footer className="relative border-t border-white/5 overflow-hidden"
      ...
      <div className="absolute top-0 left-0 right-0 h-px"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(6,95,70,0.5), rgba(5,150,105,0.5), transparent)' }} />
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
              ...
              {socials.map((s) => (
                <li key={s.label}>
                  <a
                    ...
                    className="flex items-center gap-2.5 font-body text-white/40 hover:text-emerald-400 text-sm transition-colors duration-300 group"
                  >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="font-mono text-xs text-white/20 flex items-center gap-1.5">
            Feito com <Heart size={10} className="text-emerald-500 fill-emerald-500" /> e determinação
          </p>
