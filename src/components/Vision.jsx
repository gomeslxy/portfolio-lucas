...
export default function Vision() {
  ...
  return (
    <section id="trajetoria" className="relative py-32 overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #041a0d 0%, #02010a 100%)' }}>
      ...
      <div className="absolute top-0 left-0 right-0 h-48 overflow-hidden opacity-40 pointer-events-none">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(to bottom, transparent 40%, #041a0d 100%)' }} />
      </div>

      <div className="absolute top-1/4 right-0 w-[400px] h-[400px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(2,44,34,0.6) 0%, transparent 70%)', filter: 'blur(80px)' }} />
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div ref={ref} initial={{ opacity: 0, y: 28 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="font-mono text-xs tracking-widest uppercase text-emerald-400">Trajetória</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-24">
          <div className="relative">
            ...
            <div className="absolute left-5 top-8 bottom-0 w-px pointer-events-none"
              style={{ background: 'linear-gradient(to bottom, rgba(5,150,105,0.45) 0%, transparent 100%)' }} />
              ...
              {milestones.map((m, i) => (
                <motion.div key={m.title} variants={item} className="flex gap-5 pb-10 relative">
                  ...
                  <div className="flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center z-10"
                    ...
                    <m.icon size={16} style={{ color: i === 0 ? '#6ee7b7' : '#34d399' }} />
                  </div>

                  <div className="pt-1 flex-1">
                    <div className="flex items-center gap-2 mb-1.5">
                      <span className="font-mono text-[10px] tracking-widest uppercase" style={{ color: i === 0 ? '#6ee7b7' : '#34d399' }}>
                        {m.period}
                      </span>
                      {m.highlight && (
          ...
          <div className="lg:pt-4">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="font-mono text-xs tracking-widest uppercase text-emerald-400">Perfil comportamental</span>
              </div>
            ...
            <motion.div
              ...
              style={{ background: 'rgba(4, 26, 13, 0.35)', borderStyle: 'dashed' }}
            >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.04, boxShadow: '0 0 30px rgba(6,95,70,0.5)' }}
                whileTap={{ scale: 0.97 }}
